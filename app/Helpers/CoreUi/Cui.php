...
class Cui
{
    ...
    {
        return '<a class="c-subheader-nav-link" href="'.$url.'"> <i class="'.$icon.' c-icon"></i> &nbsp;'.$text.'</a>';
    }
    ...
    public static function header_btn($url, $icon, $text = '')
    {
        return "<a href='$url' class='card-header-action'><i class='$icon'></i> $text</a>";
    }
}
